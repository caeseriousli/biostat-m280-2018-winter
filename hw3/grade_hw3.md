...
-   Q1 (21/25)
    -   Shiny app answers don't make much sense to me. How can Zoo be most expensive department?
    -   Could have done better to visualize total payroll by city.
-   Q2 (25/25)
...
-   Are the materials (files and instructions) submitted to the `master` branch sufficient for reproducing all the results? (-2 pts)
    ...
    Note that `setwd("/home/zexuan55/biostat-m280-2018-winter/hw3/hw3_shiny/data")` is unique to your account on the server. Make sure your collaborators can easily run your code.
