...
cat("Number of observations: ", as.double(total), "\n",
    ...
    "Latest ", as.character(as.POSIXct(span$max, origin="1970-01-01")), "\n",
    "Year that has the most data and count: ", as.double(yr), "\n", sep = "")
...
cat("Car make that received most citations: ", as.character(makes[1,1]), "\n", sep = "")
```
...
cat("Number of different colors of cars: ", as.character(nrow(cl)), "\n",
    "Color that attracted most tickets: ", as.character(cl[1, 1]), "\n", sep = "")
```
...
cat("Most common ticket type: ", as.character(tt[1, 1]), "\n", sep = "")
```
...
cat("Total fine collected in 2015 and 2016 ", as.character(money$tot), "\n", sep = "")
```
