...
cat("Range: \nEarliest ", as.character(as.POSIXct(span$min, origin="1970-01-01")), "\n")
cat("Latest ", as.character(as.POSIXct(span$max, origin="1970-01-01")), "\n")
cat("Year that has the most data and count: ", as.double(yr), "\n")
...
cat("Most likely: \n")
cat("Hour of the day: ", as.character(hr[1, 1]), "\n")
cat("Week day: ", as.character(wd[1, 1]), "\n")
cat("Day of the month: ", as.character(md[1, 1]), "\n")
cat("Month of the year: ", as.character(ym[1, 1]), "\n")
cat("\nLeast likely: \n")
cat("Hour of the day: ", as.character(hr[nrow(hr), 1]), "\n")
cat("Week day: ", as.character(wd[nrow(wd), 1]), "\n")
cat("Day of the month: ", as.character(md[nrow(md), 1]), "\n")
cat("Month of the year: ", as.character(ym[nrow(ym), 1]), "\n")
```
