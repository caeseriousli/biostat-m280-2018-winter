...
ggplot() +
  geom_line(data = lax_traffic, aes(x = stime, y = counts, color = season, group = year)) +
  scale_x_date(labels = function(x) format(x, "%Y")) +
  coord_fixed(0.8) +
